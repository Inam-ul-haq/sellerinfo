...
<div class="kt-portlet">
    ...
    <!--begin::Form-->
    <form class="kt-form kt-form--label-right" method="POST" action="{{ route('admin.update',$user->id) }}">
        {{ csrf_field() }}
                ...
                <div class="kt-section__body">
                    <div class="form-group row">
                        <label for="current-password"
                            class="col-lg-3 col-form-label {{ $errors->has('current-password') ? ' has-error' : '' }}">Name</label>
                        <div class="col-lg-6">
